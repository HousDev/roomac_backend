...
async createBooking(req, res) {
    ...
    if (data.paymentMethod === "online") {
      ...
      if (!tenant) {
        ...
        if (existingAssignment.length > 0) {
          ...
          console.log(`⚠️ Tenant ${tenant.id} already assigned to Room ${assign.room_number}, Bed ${assign.bed_number}`);
        ...
        // Update existing tenant with partner details
      ...
      console.log("✅ Bed assigned successfully:", bedAssignmentResult.data);
        ...
        // ========== THIRD: CREATE ONLY 2 PAYMENTS (Rent and Deposit) ==========
  ...
  if (securityDeposit > 0) {
    ...
    console.log('✅ Security deposit payment created:', depositPayment);
  }

  // Update booking payment status
  await Booking.updatePaymentStatus(booking.id, "paid");
    } else {
      // In-person booking - create enquiry
