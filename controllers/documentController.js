...
// controllers/documentController.js - Update the create function
// Find the create function and replace the entire try block:
...
const create = async (req, res) => {
  try {
    ...
    // Extract all individual fields from data_json for denormalized columns
    const dj = typeof data_json === "string" ? JSON.parse(data_json) : (data_json || {});

    // REMOVE document_number from here - it will be generated by the model
...
module.exports = { getAll, getById, create, updateStatus, remove, bulkDelete };